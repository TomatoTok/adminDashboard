...
<head>
  ...
  <title>Dashboard - Tomas Bascal</title>
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      ...
      <img src="assets/img/logo.jpg" alt="logo tomas bascal">
        <span class="d-none d-lg-block"> // Tomas Bascal</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">Tomas Bascal</span>
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="components-accordion.php">
              <i class="bi bi-circle"></i><span>Acordion</span>
            </a>
          </li>
          <?php if (false) {   ?>
            <li>
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="forms-elements.php">
              <i class="bi bi-circle"></i><span>Form Elementos</span>
            </a>
          </li>
          <?php if (false) { ?>
            <li>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Tomas Bascal</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Argentina</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Direccion</div>
                    <div class="col-lg-9 col-md-8">Avenida Siempre Viva 742</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Celular</div>
                    <div class="col-lg-9 col-md-8">22222222222</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Email</div>
                    <div class="col-lg-9 col-md-8">tomacho@example.com</div>
                  </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="fullName" type="text" class="form-control" id="fullName" value="Tomas Bascal">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="country" type="text" class="form-control" id="Country" value="Argentina">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="address" type="text" class="form-control" id="Address" value="Avenida siempre viva 742">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="phone" type="text" class="form-control" id="Phone" value="2222222222">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="email" type="email" class="form-control" id="Email" value="tomacho@example.com">
                      </div>
                    </div>
                ...
                <div class="tab-pane fade pt-3" id="profile-settings">
                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Notificaciones de Email</label>
                      <div class="col-md-8 col-lg-9">
  ...
  <footer id="footer" class="footer">
    <div class="credits">
      <a href="https://linktr.ee/tomasbascal" target="_blank" style="letter-spacing:2px;">> Tomas Bascal</a>
    </div>
  </footer><!-- End Footer -->
