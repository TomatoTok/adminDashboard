...
<body>
  ...
  <div class="container">
  <div class="row">
    <p style="font-size: 0.7rem;margin:0px;padding:0px;position:relative;right:5px;"> <small> (Basado en el Template "NiceAdmin")</small></p>
    <div class="col-sm-12 col-xs-12">
      <div class="alert alert-warning">
      <h5>Modelo Dashboard Administrador</h5>
      <hr>
      <label for="">Modelo base para un sistema tipo administrador y estadistico.</label>
    </div>
    </div>
  </div>
</div>
      ...
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Reports <span>/Hoy</span></h5>
        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">Trafico del Sitio Web <span>| Hoy</span></h5>
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">Novedades <span>| Hoy</span></h5>
